...
"""
xblock-discussion-grading documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-discussion-grading',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edunext/xblock-discussion-grading",
...
#
# html_title = 'xblock-discussion-grading v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Discussion Grading XBlock for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'discussion_grading'),
                os.path.join(root_path, 'discussion_grading/migrations')])
